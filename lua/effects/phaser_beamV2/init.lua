...
function EFFECT:Init( data )
	...
	self.texcoord = math.Rand( 0, 20 )/2
	--self.Position = data:GetStart()
	--self.WeaponEnt = data:GetEntity()
	--self.Attachment = data:GetAttachment()
	

	self.StartPos = data:GetStart()--self:GetTracerShootPos( self.Position, self.WeaponEnt, self.Attachment )
...
function EFFECT:Render( )
	...
	local texcoord = self.texcoord
		...
		render.DrawBeam( self.StartPos, 										// Start
					 ...
					 Color( 255, 150, 0, math.Clamp(self.Alpha, 255,0)) )		// Color (optional)'
	...
	local texcoord = self.texcoord
		...
		render.DrawBeam( self.StartPos, 										// Start
					 ...
					 texcoord,														// Start tex coord
					 texcoord + self.Length / 256,									// End tex coord
					 Color( 225, 100, 0, math.Clamp(self.Alpha, 255,0)) )		// Color (optional)'
	...
	local texcoord = self.texcoord
		...
		render.DrawBeam( self.StartPos, 										// Start
					 ...
					 texcoord,														// Start tex coord
					 texcoord + self.Length / 256,									// End tex coord
					 Color( 255, 0, 0, math.Clamp(self.Alpha, 255,0)) )		// Color (optional)'				 
end
