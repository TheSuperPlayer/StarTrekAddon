...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/EF2Weapons/CR/cr.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-0.955, 0, -4.092), angle = Angle(-133.978, -176.933, -88.977), size = Vector(1.116, 1.116, 1.116), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/EF2Weapons/CR/cr.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(14.272, 2.181, -2.182), angle = Angle(170.794, -101.25, 9.204), size = Vector(0.889, 0.889, 0.889), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
timer.Create("revivedelay"..Phaseruniquetimer1, 15, 1, function() self:Phaserevive(rag) end) ---------------------------------------------
end
...
function SWEP:CSShootBullet(dmg, recoil, numbul, cone)
	...
	bullet.Force 	= 1.2 * dmg     								-- Amount of force to give to phys objects
...
function SWEP:Think()
	...
	local offset = 0.09 // higher is slower.
