...
function EFFECT:Init( data )
	...
	local LeftGond = self.Shuttle:GetPos() +self.Shuttle:GetForward()*100 + self.Shuttle:GetRight()*100 + self.Shuttle:GetUp()*0
	local RightGond = self.Shuttle:GetPos() +self.Shuttle:GetForward()*100 + self.Shuttle:GetRight()*-100 + self.Shuttle:GetUp()*0
